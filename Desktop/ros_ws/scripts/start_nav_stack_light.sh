...
MAP_PATH="${VOICE_NAV_MAP:-${ROS_WS}/install/rt_robot_nav2/share/rt_robot_nav2/map/my_map6.yaml}"
...
echo -e "${YELLOW}启动 smart_switcher（落盘日志 → ~/logs/smart_switcher，保留最近 5 次）…${NC}"
SW_PID="$(ai_car_start_smart_switcher "${ROS_WS}")"
